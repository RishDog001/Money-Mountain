...
{
    public partial class QuestionForm15 : Form
    {
        ...
        private void QuestionForm15_Load(object sender, EventArgs e)
        {
        ...
        private void DisplayQuestion()
        {
            ...
            {
                new string[] { "A: 9.3 million", "B: 39 million", "C: 93 million", "D: 193 million" }
            };

            correctAnswer = "C: 93 million";
        ...
        {
            earnings = 500000; //Carry over value from previous question
        ...
        private void CheckAnswer()
        {
            ...
            {
                earnings *= 2;
                MessageBox.Show($"Congratulations! You've just won ${earnings}!", "Correct Answer", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        {
            QuestionForm16 questionForm16 = new QuestionForm16();

            if (MessageBox.Show("Ready to move onto the final question?", "Final Question", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                Close();
                questionForm16.Show();
            }
